...
```
The output is `C9H17NO2`. Note that as of `openbabel v3.2.1`, smis with explicit hydrogens not bonded to a heavy atom (such as `[H].[O][H]`) can have wrong hydrogen counts (see [this issue](https://github.com/openbabel/openbabel/issues/3008)).
